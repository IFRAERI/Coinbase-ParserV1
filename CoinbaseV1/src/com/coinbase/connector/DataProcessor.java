...
public class DataProcessor {
    ...
    public String convertPriceDataToJson(PriceData priceData) {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("price", priceData.getPrice());
        jsonObject.put("currency", priceData.getCurrency());
        jsonObject.put("timestamp", priceData.getTimestamp());
